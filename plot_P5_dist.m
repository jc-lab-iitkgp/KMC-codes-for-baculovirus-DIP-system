% This program plots the results for Passage 5.

%% Loading
clear all
load('exp_psg5.mat') % Experiment results
load('MC_PSG-5.mat') % MC results
